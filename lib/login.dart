                          ...
                          child: Material(
                              ...
                              child: FlatButton(
                                onPressed: () async {
                                  ...
                                  if (result.data['getAuthenticationbyEmail']
                                          .length ==
                                      0) {
                                    Toast.show(
                                      'The email that you entered is incorrect.',
                                      context,
                                      duration: Toast.LENGTH_LONG,
                                    );
                                  } else {
                                    String reL =
                                        result.data['getAuthenticationbyEmail']
                                            [0]['password'];

                                    if (Password.verify(
                                        _AccountInfo['password'], reL)) {
                                      globals.userid = result
